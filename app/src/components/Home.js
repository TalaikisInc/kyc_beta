...
const Help = () => (
  <Box>
    ...
    <p>* Not all proposed features would work in demo version.</p>
    ...
    <ul>
      ...
      <li><strong>Savings on KYC/ AML process</strong> - you don't need to hire staff to verify all the legal requirements and users' documents.</li>
    </ul>
